...
if "audio_success" not in st.session_state:
    st.session_state.audio_success = False
if "image_success" not in st.session_state:
    st.session_state.image_success = False
...
if st.session_state.audio_success:
...
if write_mode == "Upload Image":
    ...
    if image:
        ...
        st.session_state.image_success = True
    ...
    canvas = st_canvas(
        ...
        stroke_color="#fff" if eraser_mode else "#0f172a",
...
if st.session_state.image_success:
